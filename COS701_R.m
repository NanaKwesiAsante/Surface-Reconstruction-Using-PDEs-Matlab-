...
c = 2000;   % test different values
%when lam=100 h=20
%c=2000;there was ok but tiny holes
%c=500;there was little errors on top
%c=200;little errors on top
%c=3000;was okay but tiny holes
%c=5000; was alright but still very little holes
%lam=500
%c=5000;there were holes
%lam=1000
%c=5000;there were holes
%h=50 lam=100
%c=6000;still holes
